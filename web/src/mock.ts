  ...
  const booth: Booth = {
    ...
    settings: {
      ...
      effects: {
        ...
        strobe: { enabled: false, speed: 1.0 },
        fireworks: { enabled: false, speed: 1.0 },
        firejets: { enabled: false, speed: 1.0 },
        skybeams: { enabled: true, speed: 1.0, colorIndex: 2 },
        dancefloor: { enabled: false, speed: 1.0, colorIndex: 1 },
      },
    },
    state: {
      track: {
    ...
    window.dispatchEvent(
      new MessageEvent('message', {
        data: {
          ...
          effectsConfig: [
            { name: 'laser', label: 'Lasers', hasSpeed: true, hasColor: true, colors: [[255, 0, 80], [0, 120, 255], [0, 255, 120], [255, 200, 0], [180, 0, 255]] },
            { name: 'lights', label: 'Club Lights', hasSpeed: true },
            { name: 'strobe', label: 'Strobe', hasSpeed: true },
            { name: 'skybeams', label: 'Sky Beams', hasSpeed: true, hasColor: true, colors: [[255, 255, 255], [255, 0, 80], [0, 120, 255], [0, 255, 120], [180, 0, 255]] },
            { name: 'dancefloor', label: 'Dance Floor', hasSpeed: true, hasColor: true, colors: [[226, 75, 209], [0, 120, 255], [0, 255, 120], [255, 200, 0], [255, 0, 80]] },
            { name: 'smoke', label: 'Smoke' },
            { name: 'particles', label: 'Confetti', hasSpeed: true },
            { name: 'fireworks', label: 'Fireworks', hasSpeed: true },
            { name: 'firejets', label: 'Fire Jets', hasSpeed: true },
